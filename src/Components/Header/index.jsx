...
import logo from "../../assets/images/logo_hr.svg";
  ...
  return (
    ...
    >
      <div className="x_container h-full flex items-center justify-between">
        ...
        <button
          className="lg:hidden gap-[6px] relative w-12 h-16 flex flex-col justify-center items-center focus:border-none focus:outline-none z-50"
          onClick={() => set_omm((p) => !p)}
        >
          <span
